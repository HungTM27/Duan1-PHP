                    ...
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title">Màu Sắc Của Sản Phẩm: <span  style="color:red;font-size:12px;"><?= $rowColorProduct['product_name'] ?> </span></h4>
                                ...
                                <form class="forms-sample" action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <?php } else { ?>
                                        <input type="submit" name="addColorProductDetail" class="btn btn-danger btn-block"
                                               value="Thêm">
                                    <?php } ?>
                                </form>
                            </div>
