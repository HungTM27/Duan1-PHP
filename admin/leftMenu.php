    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="products">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="brands.php">Danh Mục Sản Phẩm (Hãng) </a></li>
                    <li class="nav-item"> <a class="nav-link" href="statusProducts.php"> Trạng Thái Sản Phẩm (Sale) </a></li>
                    <li class="nav-item"> <a class="nav-link" href="colorProducts.php"> Màu Sắc(Thêm Màu Sắc) </a></li>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="comment">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="Cart.php"> Thanh Toán Giỏ Hàng </a></li>
                </ul>
            </div>
        </li>
