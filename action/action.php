...
if (isset($_POST['addinfo'])) {
    ...
    $infor_suppost = $_POST['infor_suppost'];
    $infor_copyright = $_POST['infor_copyright'];
    move_uploaded_file($_FILES['infor_logo']['tmp_name'], '../uploads/' . $_FILES['infor_logo']['name']);
    $db->addinfo($infor_logo, $infor_address, $infor_email, $infor_phone,$infor_suppost, $infor_copyright);
    header('location:../admin/info.php');

}

    //delete infor coppyright
...
if (isset($_GET['editInfo'])) {
    ...
    $infor_suppost = $rowInfo['infor_suppost'];
...
if (isset($_POST['updateinfo'])) {
    ...
    $db->updateInfo($infor_id, $infor_logo, $infor_address, $infor_email, $infor_phone, $infor_suppost , $infor_copyright);
    header('location:../admin/info.php');
}
...
if (isset($_POST['deleteProductCart'])) {
    ...
    //  delete 0rder đặt hàng

if (isset($_GET['deleteOrderById'])) {
    $order_id = $_GET['deleteOrderById'];
...
if (isset($_POST['updateOrderById'])) {
    $order_orderStatus = $_POST['order_orderStatus'];
    $rowOrder = $db->updateOrder($order_orderStatus);
    header("Location:../admin/Cart.php");
}
