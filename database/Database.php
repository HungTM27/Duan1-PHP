...
class Database
{
    private $dsn = "mysql:host=localhost;dbname=duan1phpas1";
    private $user = "root";
    private $pass = "";
    public $connection;
...
// inFoShop //
    ...
    public function addinfo($infor_logo, $infor_address, $infor_email, $infor_phone, $infor_suppost, $infor_copyright)
    {
        $sqlinfo = "insert into infor(infor_logo, infor_address, infor_email, infor_phone,infor_suppost,infor_copyright) values (:infor_logo, :infor_address, :infor_email, :infor_phone, :infor_suppost, :infor_copyright)";
        $stmtinfo = $this->connection->prepare($sqlinfo);
        $stmtinfo->execute(['infor_logo' => $infor_logo, 'infor_address' => $infor_address, 'infor_email' => $infor_email, 'infor_phone' => $infor_phone,'infor_suppost' => $infor_suppost, 'infor_copyright' => $infor_copyright]);
        return true;
    }
    ...
    public function updateInfo($infor_id, $infor_logo, $infor_address, $infor_email, $infor_phone,$infor_suppost, $infor_copyright)
    {
        $sqlSlideShow = "update infor set infor_logo = :infor_logo, infor_address = :infor_address, infor_email = :infor_email, infor_phone = :infor_phone,infor_suppost =  :infor_suppost, infor_copyright = :infor_copyright where infor_id = :infor_id";
        $stmtSlideShow = $this->connection->prepare($sqlSlideShow);
        $stmtSlideShow->execute(['infor_logo' => $infor_logo, 'infor_address' => $infor_address, 'infor_email' => $infor_email, 'infor_phone' => $infor_phone,'infor_suppost' => $infor_suppost ,'infor_copyright' => $infor_copyright, 'infor_id' => $infor_id]);
        return true;
    }
...
// Cart //
    ...
    public function updateOrder($order_orderStatus)
    {
        $sqlComment = "update orders set order_orderStatus = :order_orderStatus";
        $stmtComment = $this->connection->prepare($sqlComment);
        $stmtComment->execute(['order_orderStatus' => $order_orderStatus]);
        return true;
    }
